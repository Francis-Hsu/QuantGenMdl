...
states_diff = np.load('data/QDDPM/noise/n2/corrNoiseDiff_n%dT%d_N5000.npy'%(n, T))
...
for t in range(19, 14, -1):
    ...
    for trial in range(repeats):
        params_all[trial], loss_all[trial], f_all[trial] = training_t(model, t, inputs_T, params_tot, Ndata, epochs, dis_measure=method)
    ...
    print('corr-noise, na=%d, t=%d, min loss=%s, F10=%s, time=%s'%(na, t+1, loss_all[idx,-1], f_all[idx,-1], t2-t1))
